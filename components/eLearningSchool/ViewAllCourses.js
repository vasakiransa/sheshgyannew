...
const ViewAllCourses = () => {
	return (
		<>
			<div className="view-all-courses-area ptb-100 bg-yellow-500">
					...
					<div className="row align-items-center">
						<div className="col-lg-6 col-md-12">
							<div className="view-all-courses-content">
								...
								<p>
									Sheshgyan training programs can bring you a
  ...
  <a className="default-btn" style={{ backgroundColor: 'orange' }}>
    <i className="flaticon-agenda"></i> Review My Wishlist <span></span>
  </a>
</Link>
